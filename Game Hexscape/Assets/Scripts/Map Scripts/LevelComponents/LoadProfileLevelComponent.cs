...
public class LoadProfileLevelComponent : BaseLevelComponent {
    ...
    {
        //InputField registerNameField;

        registerUserCanvas = Instantiate(Resources.Load(pathRegisterUserCanvas) as GameObject);
