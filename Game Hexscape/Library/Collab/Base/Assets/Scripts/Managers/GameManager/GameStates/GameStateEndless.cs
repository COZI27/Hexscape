...
public class EnergyMetre
{
    ...
    public EnergyMetre(float initialEnergy = 90, float initalAcceleration= 0.5f, int initalEnergyTier = 1)
    {
    ...
    private const float tierUpGaceBufferAmount = 10f;
...
{
    private const int energyIncreaseHexDig = 4;
    private const int energyIncreaseLevelDig = 12;
    ...
    public float playerSpeedIncreaseLogBase = 10f;
    ...
    public override void StateUpdate()
    {
        ...
        playerController.moveSpeed = playerSpeedIncreaseLogBase + speedCurve.GetY(energyMetre.currentEnergyTier) * playerSpeedIncreaseLogMultiplyer;
        Debug.Log("Tier: " + energyMetre.currentEnergyTier + " | move speed: " + playerController.moveSpeed);
    ...
    public override void HexDigEvent()
    {
        ...
        if (currentSessionData.levelScore >= currentSessionData.passScore) // Perfect
        {
            energyMetre.AddEnergy(energyIncreaseLevelDig);
            LoadNextLevel();
    ...
    internal class TierSpeedLogCurve
    {
        ...
        public TierSpeedLogCurve(float a = 2.7f, float b = 4.5f, float c = -4.1f)
        {
            this.a = a;
            this.b = b;
            this.c = c;
